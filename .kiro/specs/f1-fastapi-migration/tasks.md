...
- [ ] 1. Project setup and service layer extraction
  ...
  - [x] 1.2 Extract Jolpica service functions from Streamlit app
  ...
  - [x] 1.3 Write unit tests for Jolpica service
    - Test each service function with mocked httpx responses
    - Test error handling for API failures
    - _Requirements: 4.1_
  
  - [x] 1.4 Extract analytics calculation functions
...
- [x] 2. FastAPI application scaffold and configuration
  ...
  - [x] 2.2 Implement Redis cache layer
  ...
  - [x] 2.3 Implement request ID middleware
  ...
  - [x] 2.4 Add CORS middleware and configure logging
...
- [x] 3. Checkpoint - Verify FastAPI scaffold
  - Ensure FastAPI starts successfully with `uvicorn app.main:app --reload`
  - Verify health check endpoint returns 200
  - Verify Redis connection in logs
  - Ask the user if questions arise

- [x] 4. Implement Jolpica REST routes (historical data)
  - [x] 4.1 Create Pydantic models for standings
  ...
  - [x] 4.2 Implement standings router
  ...
  - [x] 4.6 Write unit tests for races endpoints
    - Test each endpoint with sample data
    - Test error handling for invalid year/round
    - Verify cache behavior
    - _Requirements: 4.1_

- [x] 5. Checkpoint - Verify historical data endpoints
...
- [x] 6. Implement analytics REST routes
  - [x] 6.1 Create Pydantic models for analytics responses
  ...
  - [x] 6.2 Implement analytics router - driver metrics
  ...
  - [x] 6.5 Write unit tests for analytics endpoints
...
- [x] 7. Checkpoint - Verify analytics endpoints
...
- [x] 8. Implement OpenF1 live data routes
  - [x] 8.1 Extract OpenF1 service functions
  ...
  - [x] 8.2 Implement session mode determination logic
  ...
  - [x] 8.3 Create Pydantic models for live data
  ...
  - [x] 8.4 Implement live data router
  ...
  - [x] 8.5 Write unit tests for live endpoints
...
- [x] 9. Implement WebSocket server for real-time updates
  - [x] 9.1 Create WebSocket ConnectionManager
  ...
  - [x] 9.2 Implement WebSocket router
...
- [x] 11. Create React frontend scaffold
  ...
  - [x] 11.2 Set up React Query and routing
  ...
  - [x] 11.3 Create API client and TypeScript types
  ...
  - [x] 11.5 Create shared layout components
...
- [x] 12. Implement historical data pages (React)
  - [x] 12.1 Create React Query hooks for historical data
  ...
  - [x] 12.2 Create Plotly chart components
  ...
  - [x] 12.3 Implement standings pages
  ...
  - [x] 12.5 Implement overview and championship pages
  ...
  - [x] 12.6 Write component tests for historical pages
    - Test DriverStandingsPage with MSW mocked API
    - Test loading and error states
    - Test chart rendering
    - _Requirements: 4.3_

- [x] 13. Checkpoint - Verify historical pages
...
- [x] 14. Implement analytics page (React)
  - [x] 14.1 Create React Query hooks for analytics
  ...
  - [x] 14.2 Create analytics page with tabs
  ...
  - [x] 14.3 Implement driver analytics section
  ...
  - [x] 14.4 Implement comparative analytics section
  ...
  - [x] 14.5 Write component tests for analytics page
    - Test analytics page with mocked API responses
    - Test tab navigation
    - Test driver selector
    - _Requirements: 4.3_

- [x] 15. Implement live tracker page (React)
  - [x] 15.1 Create WebSocket hook with reconnection
  ...
  - [x] 15.2 Create live data hook combining REST and WebSocket
  ...
  - [x] 15.3 Create live tracker components
  ...
  - [x] 15.4 Implement live tracker page
  ...
  - [x] 15.5 Write integration test for WebSocket hook
    - Test WebSocket connection and reconnection logic
    - Test exponential backoff timing
    - Test message parsing and state updates
    - _Requirements: 4.3_

- [x] 16. Checkpoint - Verify frontend completeness
...
- [x] 17. Docker containerization and Nginx configuration
  - [x] 17.1 Create backend Dockerfile
  ...
  - [x] 17.2 Create frontend Dockerfile
  ...
  - [x] 17.3 Create Nginx configuration
  ...
  - [x] 17.4 Create Docker Compose configuration
  ...
  - [x] 17.5 Create Docker Compose profiles for dev/prod
...
- [x] 18. Testing and final polish
  - [x] 18.1 Run backend property-based tests
  ...
  - [x] 18.4 Create deployment documentation
  ...
  - [x] 18.5 Performance optimization
...
- All context documents (requirements.md, design.md, steering files) are available during impleme2ntation
